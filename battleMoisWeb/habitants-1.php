    ...
    <tbody>
      <?php foreach ($habitants as $habitant): ?>
        <tr>
          ...
          <td>Hans-Vernier</td>
          <td><a href="delete.php?id=<?= $_GET['id'] ?>" class="btn btn-danger">Supprimer</a></td>
        </tr>
      <?php endforeach ?>
